...
mod tests {
    ...
    fn test_insert_basic() {
    	let mut match_eng = super::matching_engine::MatchingEngine::new();
    	// original orders
    	let sell_order_1 = &super::objects::Order::new(100, 1000, '2');
    	let sell_order_2 = &super::objects::Order::new(50, 1500, '2');
		let buy_order_1 = &super::objects::Order::new(200, 2000, '1');
    	...
    	let mut expected: Vec<(super::objects::Order, super::objects::Order)> = Vec::new();
		let mut buy_1_traded = super::objects::Order::new(200, 2000, '1');
    	buy_1_traded.set_transact_time(&buy_order_1.get_transact_time()); // need same transact time
    	let mut sell_1_traded = super::objects::Order::new(100, 1000, '2');
    	...
    	let mut buy_1_traded = super::objects::Order::new(100, 2000, '1');
    	buy_1_traded.set_transact_time(&buy_order_1.get_transact_time()); 
    	let mut sell_2_traded = super::objects::Order::new(50, 1500, '2');
